...
"""
Created 2020-03-16
https://github.com/fullysprinkled
anthony2owaru@gmail.com

Description:
- Pulls all instances of Zendesk tickets linked to Jira by paginating through Zendesk's Jira integration API endpoint
- Pulls more ticket data for those instances and merges together
    - You can edit this part to pull other ticket data excluding custom fields
- Outputs to CSV
*this script requires you to add your zendesk org login email and an API token generated by an admin user*
"""
import requests
import json
import csv
...
zd_user = 'YOUR_LOGIN_EMAIL_ADDRESS/token'
...
def dict_to_csv(merged_dict):
    ...
    zd = zip(*all_ticket_data.values())
    with open(out_path, 'w') as file:
        writer = csv.writer(file, delimiter=',')
        writer.writerow(all_ticket_data.keys())
        writer.writerows(zd)
