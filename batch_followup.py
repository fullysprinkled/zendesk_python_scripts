...
def post_followup_tickets(form_id, copy, ticket_ids):
    for ticket_id in ticket_ids:
        ##custom fields are like so:  "custom_fields": [{"id": 123, "value": "value"}, ...]
        data = {"ticket": {"via_followup_source_id": ticket_id, "subject": "YOUR_SUBJECT_HERE", "comment": {"body": copy}, "assignee_id":364484967074,"ticket_form_id": form_id, "status":"pending", "custom_fields":[{"id":360007552794,"value":"service___batch_send_reply_"}]}}
...
def main():
    ...
    followup_form_id = "YOUR_TICKET_FORM_ID" # the form ID you'll assign every ticket to (NOTA)
